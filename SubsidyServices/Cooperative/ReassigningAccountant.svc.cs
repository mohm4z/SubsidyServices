...
namespace SubsidyServices.Cooperative
{
    ...
    public class ReassigningAccountant : IReassigningAccountant
    {
            ...
            )
        {
            ...
            {
                /// Data Validations
                DataValidation.IsEmptyOrDefault2(AccountantInfo);
                DataValidation.IsEmptyOrDefault2(AccountantInfo.CheckedData);
                DataValidation.IsEmptyOrDefault2(AccountantInfo.ManagersInfo);
                DataValidation.IsEmptyOrDefault2(AccountantInfo.CooEmployeeInfo);
