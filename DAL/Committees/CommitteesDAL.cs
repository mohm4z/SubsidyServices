    ...
    public class CommitteesDAL : IDisposable
    {
            ...
            )
        {
            List<SpInPuts> inputs = new List<SpInPuts>
            {
                ...
                new SpInPuts(){KEY = "P_PROG_REQUEST_AMOUNT" , VALUE = obj.ProposedGovernmentContribution},
                new SpInPuts(){KEY = "P_CME_REV_CASH" , VALUE = obj.CivilMonetaryContribution},
                new SpInPuts(){KEY = "P_CME_REV_ITEMS" , VALUE = obj.CivilContributionKind},
                new SpInPuts(){KEY = "P_EX_GOV_REV_CASH" , VALUE = obj.LastYearSurplus},
                new SpInPuts(){KEY = "P_PROG_NAME" , VALUE = obj.ProjectName},
                new SpInPuts(){KEY = "P_PROJ_DURATION_TYPE" , VALUE = obj.ProjectDurationType},
                new SpInPuts(){KEY = "P_PROJ_DURATION" , VALUE = obj.ProjectDuration},
                new SpInPuts(){KEY = "P_INITIATIVE_NO" , VALUE = obj.InitiativeCode},
                new SpInPuts(){KEY = "P_PROGRAM_CD" , VALUE = obj.TheProgram},
                new SpInPuts(){KEY = "P_PROJ_CD" , VALUE = obj.Classification},
                new SpInPuts(){KEY = "P_PROG_GOALS" , VALUE = obj.ProjectGoals},
                new SpInPuts(){KEY = "P_REQ_SUBSCRIPTION_FEES" , VALUE = obj.SubscriptionFee},
                new SpInPuts(){KEY = "P_PROJ_SITUATION" , VALUE = obj.ProjectStatus},
                new SpInPuts(){KEY = "P_EXP_BEN_CNT" , VALUE = obj.BeneficiariesExpectedNumber},
                new SpInPuts(){KEY = "P_RESIDENCE_CD" , VALUE = obj.HeadquarterType},
                new SpInPuts(){KEY = "P_PRJ_EMP_COUNT" , VALUE = obj.EmployeesNumber},
                new SpInPuts(){KEY = "P_RENT_AMOUNT" , VALUE = obj.RentAmount},
                new SpInPuts(){KEY = "P_PRJ_SALARIES" , VALUE = obj.TotalEmployeeSalaries},
                new SpInPuts(){KEY = "P_PRJ_FIXEDASSETS" , VALUE = obj.FixedAssetsValue},
                new SpInPuts(){KEY = "P_PRJ_EXPENSES" , VALUE = obj.OtherExpenses},
